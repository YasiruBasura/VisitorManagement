...
import ResearchTable from "./researchTableRow";

export default class ViewResearch extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    axios
      .get("http://localhost:4000/Research/ViewResearch/")
      .then((response) => {
        // alert('Pass una')
  ...
  tabRow() {
    return this.state.natives
      ...
      .map((object, i) => {
        return <ResearchTable obj={object} key={i} />;
      });
        ...
        <div class="content">
          ...
          <div>
            ...
            <a
              ...
              href="http://localhost:4000/Research/ResearchReport"
              align="left"
