...
import UserTable from "./userTableRow";

export default class ViewUserData extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios
      .get("http://localhost:4000/User/ViewUserData/")
      .then((response) => {
        ...
        <div className="content">
          ...
          <div>
            <a
              ...
              href="http://localhost:4000/User/UserReport"
              align="left"
