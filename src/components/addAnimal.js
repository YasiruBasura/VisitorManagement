        ...
        <div class="content4">
          ...
          <div className="container" style={{}}>
            ...
            >
              ...
              <div class="">
                <div class="col-auto">
                  <label class="col-form-label">Feeding Time 1:</label>
                </div>
                <div class="col-auto">
                  <input
                    type="time"
              ...
              <div class="">
                <div class="col-auto">
                  <label class="col-form-label">Attended Zoo keeper :</label>
                </div>
                <div class="col-auto">
                  <input
                    type="text"
              ...
              <div className="right-side">
                <div class="">
                  <div class="col-auto">
                    <label class="col-form-label">
                      Date of treatment & medical care :
                    </label>
                  </div>
                  <div class="col-auto">
                    <input
                ...
                <div class="">
                  <div class="col-auto">
                    <label class="col-form-label">
                      Time of treatment & medical care :
                    </label>
                  </div>
